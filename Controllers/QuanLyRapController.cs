  ...
  public class QuanLyRapController: ControllerBase {
    ...
    public async Task < ResponseEntity > LayThongTinHeThongRap(string maHeThongRap = "") {
        if (string.IsNullOrEmpty(maHeThongRap)) {
          return new ResponseEntity(StatusCodeConstants.OK, db.HeThongRap.Select(n => new {
            n.MaHeThongRap, n.TenHeThongRap, n.BiDanh, Logo = DomainImage + n.Logo
          }), MessageConstant.MESSAGE_SUCCESS_200);
        }
        var lstResult = db.HeThongRap.Where(n => n.MaHeThongRap == maHeThongRap).Select(n => new {
          n.MaHeThongRap, n.TenHeThongRap, n.BiDanh, Logo = DomainImage + n.Logo
        });
    ...
    public async Task < ResponseEntity > LayThongTinCumRapTheoHeThong(string maHeThongRap = "") {
      ...
      IEnumerable < ThongTinCumRapVM > lstResult = lstCumRap.Select(n => new ThongTinCumRapVM {
        MaCumRap = n.MaCumRap, TenCumRap = n.TenCumRap, DiaChi = n.ThongTin, DanhSachRap = db.Rap.Where(e => e.MaCumRap == n.MaCumRap).Select(p => new RapVM {
          MaRap = p.MaRap, TenRap = p.TenRap
        })
      });
      return new ResponseEntity(StatusCodeConstants.OK, lstResult, MessageConstant.MESSAGE_SUCCESS_200);
    }
    ...
    public async Task < ResponseEntity > LayThongTinLichChieuHeThongRap(string maHeThongRap = "", string maNhom = "GP01") {
        ...
        foreach(var ghtr in lstLichChieu.GroupBy(n => new {
          n.MaHeThongRap, n.TenHeThongRap, n.Logo
        })) {
          ...
          foreach(var cumRap in ghtr.GroupBy(n => new {
            n.MaCumRap, n.TenCumRap, n.ThongTin
          })) {
            ...
            foreach(var phim in cumRap.GroupBy(n => new {
              n.MaPhim, n.TenPhim, n.HinhAnh, n.DangChieu, n.SapChieu, n.Hot
            })) {
    ...
    public async Task < ResponseEntity > LayThongTinLichChieuPhim(int MaPhim = 0) {
      ...
      foreach(var item in db.HeThongRap) {
        ...
        var lstLichChieu = conn.Query < LichChieuMapView > (query);
        foreach(var htr in lstLichChieu.GroupBy(n => new {
          n.MaHeThongRap, n.TenHeThongRap, n.Logo
        })) {
          ...
          foreach(var cumRap in htr.GroupBy(n => new {
            n.MaCumRap, n.TenCumRap, n.ThongTin
          })) {
